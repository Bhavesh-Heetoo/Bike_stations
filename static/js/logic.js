...
function createMap(bikeStations) {
  ...
  myMap = L.map("map-id", {
    center: newYorkCoords, // Use predefined coordinates
    zoom: mapZoomLevel, // Use predefined zoom level
    layers: [streetmap] // Initialize with the streetmap only
  });
  ...
  let bikeLayer = L.layerGroup(bikeStations); // Assuming bikeStations is an array of markers
  let overlayMaps = {
